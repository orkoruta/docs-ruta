...
Última actualización: 2026-05-27 — **Sprint 1 BACK + QA + ADMIN-1 + STORE-1 + STORE-2 cerradas; CI de `frontend-ruta/main` desbloqueado y verde.** 8 tareas backend + 1 shared + 1 QA + 1 admin + 2 storefront cerradas. Storefront nativo completo: catálogo, detalle de producto, registro y login BUYER. Pendiente: 1.ADMIN-2/3/4.
