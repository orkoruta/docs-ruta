...
Última actualización: 2026-05-26 — `CODEBUFF.md` removido por solicitud del usuario; `0.DOCS-1` sigue cerrada en rama `docs/close-0-docs-1` con PR #1 abierto contra `main`: https://github.com/orkoruta/docs-ruta/pull/1. Pendientes de ejecucion: create_first_admin_ruta.sh y seed_dev_data.sh. Pendientes de infra: push/publicacion de otros repos, servicios Render (0.INFRA-7).
