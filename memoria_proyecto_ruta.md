...
|---|---|---|---|---|
| 2026-05-24 | ðŸ“ Setup | CreaciÃ³n de `CODEBUFF.md` â€” manifiesto para Codebuff/Buffy con flujo automÃ¡tico de trabajo, herramientas, comandos por repo y reglas operativas | `CODEBUFF.md` | Sprint 0 |
...
| 2026-05-24 | ðŸ“ Setup | VerificaciÃ³n de compatibilidad de `.md` con Codebuff/DeepSeek â€” confirmado que `AGENTS.md` es suficiente pero `CODEBUFF.md` optimiza el flujo | `CODEBUFF.md` | Sprint 0 |
| 2026-05-24 | ðŸ“ Setup | Agregada PARTE 6 (HistÃ³rico de cambios) a este documento + regla de actualizaciÃ³n permanente en `CODEBUFF.md` | `memoria_proyecto_ruta.md`, `CODEBUFF.md` | Sprint 0 |
...
| 2026-05-26 | Documentacion | Cerrada `0.DOCS-1`: documentacion inicial consolidada en `docs-ruta`, `CODEBUFF.md` agregado, manifiestos y plan/memoria actualizados; normalizados finales de linea en archivos de texto para que `git diff --check` pase limpio. Commit local `92b5ddb` en rama `docs/close-0-docs-1`; rama subida a GitHub y PR abierto contra `main`: https://github.com/orkoruta/docs-ruta/pull/1. | `docs-ruta`, `docs-ruta/plan_tareas.md`, `docs-ruta/memoria_proyecto_ruta.md`, GitHub PR #1 | Sprint 0 |
...
|---|---|---|---|
| `0.DOCS-1` (ext.) | âœ… | CreaciÃ³n de `CODEBUFF.md` â€” manifiesto optimizado para Codebuff/Buffy | `docs-ruta/CODEBUFF.md` |
...
| `0.DOCS-1` (ext.) | âœ… | Regla de actualizaciÃ³n de memoria incorporada en `CODEBUFF.md` | `docs-ruta/CODEBUFF.md` |
...
| `0.DOCS-1` (ext.) | âœ… | Registrada autorizaciÃ³n operativa para ejecutar acciones necesarias sin confirmaciÃ³n manual previa, con escalaciÃ³n directa cuando el runtime la exija y reglas persistentes acotadas | `docs-ruta/AGENTS.md`, `docs-ruta/CLAUDE.md`, `docs-ruta/CODEBUFF.md`, copias por repo, `docs-ruta/memoria_proyecto_ruta.md` |
...
| `0.DOCS-1` | [x] Cerrada | Commit y push realizados en rama `docs/close-0-docs-1`; PR abierto contra `main`: https://github.com/orkoruta/docs-ruta/pull/1. Verificacion: `git diff --check` OK. | `docs-ruta`, PR #1 |
| `0.INFRA-4` | [/] CI listo / publish pendiente | Agregados workflows `.github/workflows/ci.yml` y `publish.yml` en `packages-ruta`; scripts `ci`, `generate`, `publish:db` y `publish:packages`; `.npmrc` ya apunta a GitHub Packages. Falta accion externa: secret `NPM_PUBLISH_TOKEN`, push/merge a `main` y validacion de publicacion real en GitHub Packages. | `packages-ruta/.github/workflows/*`, `packages-ruta/package.json`, `packages-ruta/.npmrc` |
...
Última actualización: 2026-05-26 — `0.DOCS-1` cerrada en rama `docs/close-0-docs-1` con PR #1 abierto contra `main`: https://github.com/orkoruta/docs-ruta/pull/1. Pendientes de ejecucion: create_first_admin_ruta.sh y seed_dev_data.sh. Pendientes de infra: push/publicacion de otros repos, servicios Render (0.INFRA-7).
