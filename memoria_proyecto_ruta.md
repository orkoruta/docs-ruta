...
Última actualización: 2026-05-27 — **Sprint 0 cerrado.** `ruta-api` (Web Service) + `ruta-admin` y `ruta-storefront` (Static Sites) desplegados en Render. BD DEV sembrada. ADMIN_RUTA creado. Listo para Sprint 1.
